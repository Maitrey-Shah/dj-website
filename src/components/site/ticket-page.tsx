...
const inputClass =
  "border-border/70 bg-background focus:border-gold w-full rounded-lg border px-4 py-3 text-sm outline-none transition-colors";
    ...
    >
      ...
      {ready ? (
        <div className="border-border/60 rounded-lg border p-4 text-sm">
          <p className="font-semibold">Details saved. Payment is not connected yet.</p>
          <p className="text-muted-foreground mt-2">
            Online card payment will go live once a payment provider is connected. To confirm your
            tickets now, message us on WhatsApp and we'll hold them for you.
          </p>
          <a
            href={waEvent}
            target="_blank"
            rel="noopener noreferrer"
            className="bg-whatsapp text-background mt-4 inline-flex items-center gap-2 rounded-full px-6 py-3 text-xs font-bold tracking-[0.22em] uppercase"
          >
